...
import Punch from '../assets/images/TATAPunch.jpg';
    ...
    return (
        <div>
            <div className="C1" style={{width: "100%"}}>    
                <h1 id="Heading">Tata Tiago</h1>
                <img src={Tiago} id='ImageHeading' alt="Tiago car image" title='TATA Tiago' style={{ width: '500px', height: '300px', objectFit: 'cover' }} />
