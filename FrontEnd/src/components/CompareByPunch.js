...
import Punch from '../assets/images/TATATigorCarEV.webp';

const CompareByPunch = () => {

    return (
        <div>
            <div className="C1" style={{width: "100%"}}>    
                <h1 id="Heading">Tata Nexon</h1>
                <img src={Nexon} id='ImageHeading' alt="Nexon car image" title='TATA Nexon' style={{ width: '500px', height: '300px', objectFit: 'cover' }} />
                ...
                <h1>Tata Punch</h1>
                <img src={Punch} alt='Tata Punch' title='Tata Punch' style={{ width: '500px', height: '300px', objectFit: 'cover' }} />
                <table border="4" align='center'>
                    <thead>
                        <tr style={{border: "3.2px solid green"}}>
                            <th>Specification</th>
