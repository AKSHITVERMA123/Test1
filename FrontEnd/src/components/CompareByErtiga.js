    ...
    return (
        <div>
            <div className="C1" style={{width: "100%"}}>    
                ...
                <h1>Maruti Ertiga</h1>
                <img src={Ertiga} alt='Maruti Ertiga' title='TMaruti Ertiga' style={{ width: '500px', height: '300px', objectFit: 'cover' }} />
                <table border="4" align='center'>
                    <thead>
                        <tr style={{border: "3.2px solid green"}}>
                            <th>Specification</th>
...
export default CompareByErtiga;